...
- In-app updates: Gloam checks daily and installs signed updates for you.
- One editor for photo slideshows — add, remove, reorder, and retime photos.
...
- Live wallpaper now follows every Mission Control desktop.
